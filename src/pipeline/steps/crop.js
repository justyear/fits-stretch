...
function stepCrop(img, params, report){
  ...
  /* A MEDIANA E O MADN DO CEU VAO EM TODO RECORD, INCLUSIVE NOS QUE RECUSAM.
   *
   * Eles nao servem a esta etapa: servem a quem compara. A cota da contagem por
   * limiar tem que sair do numero que ESTA no limiar, e sem estes dois o
   * comparador nao consegue calcular o Delta -- cai numa cota de 0,05% dos
   * pixels do quadro, que para 12 componentes vale 960 e nunca reprova.
   *
   * O caminho que recusa e justamente onde isso doia: sete dos treze fixtures
   * recusam, e eram exatamente os sete sem cota derivada.
   */
  var skyRec = null;
  function refuse(reason, extra){
    ...
    if (skyRec){ rec.skyMedian = skyRec.median; rec.skyMadn = skyRec.madn; }
