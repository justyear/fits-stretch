 ...
 *
 * Hoje TODAS as sete sao SUPOSTO. Isso nao as torna erradas -- torna-as nao
 * verificadas, que e uma coisa diferente e que so aparece quando esta escrita.
 *
 * O que fecha cada uma e um arquivo do programa correspondente com a operacao
 * aplicada, reportando so as linhas de HISTORY. Ver investigacao-regra-linear.md
 * secao 3.2: um arquivo do Siril ja esticado decide as quatro primeiras.
 *
 * A ORDEM IMPORTA: o laco pula uma regra cujo rotulo ja esta em `historyHits`.
 */
var STRETCH_HISTORY = [
  // SUPOSTO -- termo do Siril para o esticamento automatico. E o candidato mais
  // provavel de ser confirmado primeiro, e o que o arquivo do Leon decide.
  [/autostretch/i,            'Autostretch'],
  // SUPOSTO -- "Histogram Transformation" existe no Siril e no PixInsight; qual
  // deles grava a frase, e com que capitalizacao, nao foi verificado.
  ...
  // SUPOSTO, E A MAIS ARRISCADA DAS SETE: `curves` e palavra comum em ingles e
  // pode casar em linha de HISTORY que nao fala de esticamento nenhum. As outras
  // seis sao termos tecnicos; esta nao e. Falso positivo aqui reduz o limiar da
  // regra linear de 0,05 para 0,02 num quadro que nunca foi esticado.
  [/\bcurves?\b/i,            'Curves'],
