...
does with it. Both are generated by `test/fixtures/fixture-gradient.fit`, which
is synthetic — no one else's data is in this repository.*
...
• Autostretch — midtones transfer function (PixInsight STF / Siril autostretch), shadow clip -2.80σ, target background 0.25, applied per channel (unlinked). Highlights untouched at 1.000.
    R  median 0.01848  MADN 0.00139  →  shadows 0.01458  midtones 0.01177
    G  median 0.01675  MADN 0.00139  →  shadows 0.01287  midtones 0.01171
    B  median 0.01521  MADN 0.00138  →  shadows 0.01134  midtones 0.01167
    0.099% of pixels land on pure black or pure white after the transfer.
...
the repository as `test/golden/gradient-fixture.log.txt` and compared
